...
export default function BookingDetail1G({ airports }: BookingDetailProps) {
  ...
  if (data?.flights?.length) {
    data.flights.map((flightItem: any, index: number) => {
      ...
      totalPriceAdt = flightItem.totalPriceAdt;
      totalPriceChd = flightItem.totalPriceChd;
      totalPriceInf = flightItem.totalPriceInf;
      totalPriceTicketAdt = flightItem.fareAdultFinal;
      totalPriceTicketChd = flightItem.fareChildFinal;
      totalPriceTicketInf = flightItem.fareInfantFinal;
      totalTaxAdt = flightItem.totalTaxAdt;
      totalTaxChd = flightItem.totalTaxChd;
      totalTaxInf = flightItem.totalTaxInf;
    });
  }
        ...
        <div className="mt-6">
          ...
          >
            <div>
              ...
              {fareData.map((item: any, indexFlight: number) => {
                const flight = item.selectedTicketClass;
