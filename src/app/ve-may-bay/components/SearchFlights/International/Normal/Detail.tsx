...
const FlightInternationDetail = ({
  ...
  const handleSelectFlight = (
    ...
    flightSelected.selectedTicketClass = flightSelected.fareOptions?.[optIndex];
    onSelectFlight(flightSelected, "flights-normal-rt", e);
  };
  ...
  return (
    <Fragment>
      {flight.fareOptions.map((option: any, optIndex: number) => (
        <div className="h-fit p-2 pb-0" key={optIndex}>
          <div className="grid grid-cols-8 mb-2 last:mb-0 items-start md:items-center justify-between rounded-lg bg-white p-3 md:py-6 md:px-8 border border-gray-200">
            <div className="col-span-2 border-r border-gray-200">
              ...
              <button
                ...
                onClick={() =>
                  setFlightDetail(flight, optIndex, [
            ...
            <div className="col-span-8 w-full md:col-span-2 text-center md:text-right xl:pr-8">
              <input
                ...
                onChange={(e) => handleSelectFlight(flight, optIndex, e)}
                type="radio"
