      ...
      <div className="w-full md:w-7/12 lg:w-8/12 mt-4 md:mt-0 ">
        ...
        <div className="mt-6">
          ...
          {fareData.map((item: any, key: number) => {
            ...
            return (
              <div key={key} className="bg-white rounded-xl p-3 md:p-6 mt-3">
                ...
                <div className="flex flex-col-reverse lg:flex-row items-start justify-between mt-4 lg:space-x-3">
                  <div className="w-full lg:w-2/12 mt-5 lg:mt-0">
                    <div className="flex flex-row lg:flex-col justify-between lg:justify-normal items-center md:items-baseline w-full text-left mb-3">
                      ...
                      <div className="">
                        <h3
                          className="text-sm md:text-18 font-semibold my-2"
                  ...
                  <div className="lg:w-10/12 text-center flex justify-between">
                    <div className="flex gap-6 w-full">
                      <div className="w-[30%] flex flex-col items-center md:items-start justify-start">
                        ...
                        <span className="mt-2 text-sm text-gray-500">
                          {fromOption ? (
                            <p>
                              {`${fromOption?.city} (${flight.StartPoint})`}
                            </p>
                          ) : (
                            <p>{flight.StartPoint}</p>
                          )}
                        </span>
                      </div>
                      ...
                      <div className="w-[30%] flex items-center space-x-3">
                        <div className="flex flex-col space-y-2 items-center w-full">
                          ...
                          <span className="text-sm text-gray-500">
                            {flight.HasStop ? "1 điểm dừng" : "Bay thẳng"}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="w-[30%] flex flex-col items-center md:items-start justify-start">
                        ...
                        <span className="mt-2 text-sm text-gray-500">
                          {toOption ? (
                            <p>{`${toOption?.city} (${flight.EndPoint})`}</p>
                          ) : (
                            <p>{flight.EndPoint}</p>
                          )}
                        </span>
