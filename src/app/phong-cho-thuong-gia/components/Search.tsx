    ...
    <div className="flex flex-col lg:flex-row mt-6 md:gap-4 items-start pb-8">
      ...
      <div className="w-full lg:w-9/12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          <h1 className="text-32 font-bold">{t("phong_cho_thuong_gia")}</h1>
                      ...
                      <Link href={`/phong-cho-thuong-gia/${item.slug}`}>
                        {item.image_url && item.image_location ? (
                          <Image
                            ...
                            alt={renderTextContent(item.name) || "Image"}
                            width={360}
                            height={270}
                            sizes="100vw"
                            style={{ height: 217 }}
                          ...
                          <div
                            className="hover:scale-110 ease-in duration-300 cursor-pointer h-full w-full object-cover bg-gray-200 flex items-center justify-center text-gray-500"
                            style={{ height: 217 }}
                          >
                            No Image
                          </div>
