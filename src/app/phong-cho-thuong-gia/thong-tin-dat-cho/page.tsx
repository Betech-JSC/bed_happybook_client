...
function getMetadata(data: any) {
  return formatMetadata({
    ...
    alternates: {
      canonical:
        data?.canonical_link || pageUrl("phong-cho-thuong-gia/thong-tin-dat-cho", true),
    },
    openGraph: {
      images: [
        {
...
export default async function BookingBusinessLounge() {
  ...
  return (
    <SeoSchema
      ...
      breadscrumbItems={[
        {
          url: pageUrl("phong-cho-thuong-gia", true),
