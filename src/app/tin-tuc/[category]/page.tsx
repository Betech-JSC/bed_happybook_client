      ...
      <div className="flex flex-col md:flex-row mt-12 md:space-x-16">
        <div className="basis-[65%]">
          ...
          <div className="border-b-[1px] border-gray-300">
            <ul className="flex">
              <li className="text-sm font-medium text-gray-700 py-[6px] px-[10px] text__default_hover">
                <Link href="/tin-tuc/lam-visa/visa-duc">VISA Pháp</Link>
              </li>
              <li className="text-sm font-medium text-gray-700 py-[6px] px-[10px] text__default_hover">
                <Link href="/tin-tuc/lam-visa/visa-duc">VISA Đức</Link>
              </li>
              <li className="text-sm font-medium text-gray-700 py-[6px] px-[10px] text__default_hover">
                <Link href="/tin-tuc/lam-visa/visa-duc">VISA Anh</Link>
              </li>
              <li className="text-sm font-medium text-gray-700 py-[6px] px-[10px] text__default_hover">
                <Link href="/tin-tuc/lam-visa/visa-duc">VISA Trung Quốc</Link>
              </li>
              <li className="text-sm font-medium text-gray-700 py-[6px] px-[10px] text__default_hover">
                <Link href="/tin-tuc/lam-visa/visa-duc">VISA Mỹ</Link>
              </li>
            </ul>
          </div>
          <div className="mt-8">
