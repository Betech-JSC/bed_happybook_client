      ...
      <div className="base__content">
        ...
        <div className="flex flex-col-reverse md:flex-row md:space-x-8 mt-4 pb-8">
          <div className="mt-4 md:mt-0 md:w-3/5 lg:w-[76%] p-6 bg-white rounded-2xl">
            ...
            <p className="mt-4">
              Nội dung chuyển khoản quý khách hàng cần ghi rõ:MÃ ĐẶT CHỖ/MÃ ĐƠN
              HÀNG
            </p>
            ...
            <div className="mt-4">
              ...
              <p className="text-base text-gray-900 mt-3">
                ...
                toàn của chính chủ, nhân viên của Happy Book, nên bạn hoàn toàn
                có thể an tâm.
              </p>
              <p className="text-base text-gray-900 mt-3">
                Happy Book xin chân thành cảm ơn sự đóng góp và đồng hành của
                tất cả các quý khách hàng đã tin tưởng tại chúng tôi. Happy Book
                đảm bảo sẽ mang cho bạn đến những lựa chọn tốt nhất, trên cả sự
                mong đợi nhé. Nếu có gặp khó khăn về vé máy bay hay làm visa,
