...
import Schedule from "../../fast-track/components/Schedule";
import Image from "next/image";
import { renderTextContent } from "@/utils/Helper";
import Link from "next/link";
import DisplayPrice from "@/components/base/DisplayPrice";
import { cloneDeep, isEmpty } from "lodash";
import TicketOptionContent from "../../fast-track/components/TicketOptionContent";
                  ...
                  >
                    ...
                    {option.prices?.length > 0 && (
                      <div className="text-end mt-6 mb-2">
                        <Link
                          href={`/business-lounge/checkout/${detail?.slug}?option=${option.id
