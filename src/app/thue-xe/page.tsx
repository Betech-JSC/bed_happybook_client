...
function getMetadata(lang: string) {
  ...
  return formatMetadata({
    title: isVi ? "Dịch Vụ Thuê Xe & Đưa Đón Sân Bay Giá Rẻ" : "Car Rental & Airport Transfer Service",
    description: isVi 
      ? "Dịch vụ thuê xe du lịch, tự lái, có lái và đưa đón sân bay chu đáo 24/7. Hỗ trợ đặt xe nhanh chóng qua Zalo OA."
      : "Tourist, self-drive, chauffeur-driven, and airport transfer car services 24/7. Fast booking support via Zalo OA.",
    alternates: {
      canonical: pageUrl("thue-xe", true),
    },
  });
}
        ...
        <div className="px-3 lg:px-[80px] pt-3 max__screen mx-auto">
          ...
          <div className="mt-6 bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-10 max-w-[800px] mx-auto text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">
              {isVi ? "Thông Báo Đăng Ký Dịch Vụ" : "Service Registration Notice"}
            </h2>

            <div className="text-gray-600 leading-relaxed space-y-4 mb-8 text-left md:text-center max-w-[620px] mx-auto">
              <p className="font-medium text-base">
                {isVi
                  ? "Dịch vụ thuê xe du lịch, thuê xe tự lái và đưa đón sân bay hiện đang được tiếp nhận trực tiếp qua tổng đài hỗ trợ."
                  : "Car rental, self-drive rental, and airport transfer services are currently handled directly via support channels."}
              </p>
              <p>
                {isVi
                  ? "Quý khách vui lòng liên hệ với chúng tôi qua Zalo Official Account (Zalo OA) để lựa chọn dòng xe phù hợp (4 chỗ, 7 chỗ, 16 chỗ,...) và nhận báo giá ưu đãi nhất cho hành trình của mình."
                  : "Please contact us via Zalo Official Account (Zalo OA) to choose the right car type (4-seater, 7-seater, 16-seater,...) and get the best price quote for your journey."}
              </p>
