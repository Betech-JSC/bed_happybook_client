...
export default function FormCheckOut({
  ...
  const [schemaForm, setSchemaForm] = useState(() =>
    CheckOutDinhCuSchema(messages, generateInvoice)
  );

  useEffect(() => {
    setSchemaForm(CheckOutDinhCuSchema(messages, generateInvoice));
  ...
  const onSubmit = async (data: CheckOutDinhCuType) => {
    try {
      setLoading(true);
      const formatData = {
      ...
      const respon = await BookingProductApi.DinhCu(formatData);
