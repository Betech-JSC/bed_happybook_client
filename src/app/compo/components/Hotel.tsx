    ...
    <Fragment>
          ...
          <div>
            ...
            <div className="flex space-x-2 items-center mt-3">
              <Image
                ...
                height={18}
              />
              <span className="text-sm">15 Ngô Quyền, Hoàn Kiếm - Hà Nội</span>
            </div>
          </div>
            ...
            <div className="p-3 flex flex-col justify-between h-full">
              <div className="flex-grow">
                ...
                <div className="mt-3 p-2 rounded-lg bg-gray-100">
                  ...
                  <p className="mt-3">
                    46 USD dùng thanh toán thức ăn và đồ uống mỗi phòng, mỗi lần
                    lưu trú
                  </p>
                  <p className="mt-3">Nhận phòng sớm miễn phí (sớm 2 giờ)</p>
                  <p className="mt-3">Trả phòng muộn miễn phí (muộn 2 giờ)</p>
                </div>
              </div>
              <div>
                <div className="mt-4 text-right">
                  ...
                  <p className="mt-2 text-sm text-gray-500">bao gồm thuế phí</p>
                </div>
                <div className="mt-4">
      ...
      <div className="w-full mt-6">
        <div className="bg-white rounded-2xl p-6">
          ...
          <div className="mt-3 line-clamp-5">
            ...
            dịch vụ massage, trị liệu toàn thân chăm sóc da mặt ngay trong khuôn
            viên. Đừng bỏ qua cơ hội tận hưởng những dịch vụ, tiện nghi thể
            thao, giải trí như hộp đêm, câu lạc bộ sức khỏe hay hồ bơi ngoài
            trời. Các tiện ích, dịch vụ khác tại Khách sạn phong cách kiến trúc
            Thuộc địa này bao gồm quyền truy cập Internet không dây miễn phí,
            dịch vụ tư vấn/hỗ trợ khách và dịch vụ trông trẻ (phụ phí). Hãy tự
            thưởng cho mình những ngày nghỉ tại một trong 364 phòng được trang
            bị lò sưởi. Giường nệm có lớp đệm bông đi cùng chăn bông và bộ đồ
            giường cao cấp
          </div>
      ...
      <div className="w-full mt-6">
        <div className="bg-white rounded-2xl p-6">
          ...
          <p className="mt-2">
            ...
            phí). Để sử dụng dịch vụ, khách phải liên hệ nơi lưu trú qua thông
            tin liên hệ được cung cấp trong xác nhận đặt phòng 24 giờ trước khi
            đến. Nhân viên tiếp tân sẽ đón tiếp khách tại nơi lưu trú. Nơi lưu
            trú này cho phép tối đa 1 nôi/cũi (giường cho trẻ sơ sinh) hoặc 1
            giường gấp/giường phụ trong một số phòng khách.
          </p>
      ...
      <div className="w-full mt-6">
        <div className="bg-white rounded-2xl p-6">
          ...
          <p className="mt-2">
            Danh sách trên có thể không đầy đủ. Phí và đặt cọc có thể không bao
            gồm thuế và có thể thay đổi.
          </p>
          <p className="text-18 font-semibold mt-4">Cần biết</p>
          <ul className="mt-2 list-disc  pl-4">
            <li className="mt-2">
              Có thể thu phí thêm người với mức phí khác nhau, tùy chính sách
              riêng
            </li>
            <li className="mt-2">
              Có thể cần giấy tờ tùy thân hợp pháp có ảnh và cần đặt cọc bằng
              thẻ tín dụng, thẻ ghi nợ hoặc tiền mặt (cho các chi phí phát sinh
              - nếu có) khi làm thủ tục nhận phòng
            </li>
            <li className="mt-2">
              Tùy thuộc vào tình hình thực tế khi nhận phòng mà các yêu cầu đặc
              biệt có được đáp ứng hay không và có thể thu phụ phí. Không đảm
              bảo đáp ứng mọi yêu cầu đặc biệt
            </li>
            <li className="mt-2">
              Tên trên thẻ tín dụng sử dụng khi nhận phòng để trả cho các khoản
              phí phát sinh phải trùng tên với khách lưu trú chính trong đặt
              phòng
            </li>
            <li className="mt-2">
              Nơi lưu trú này nhận thanh toán bằng thẻ tín dụng, thẻ ghi nợ và
              tiền mặt
            </li>
            <li className="mt-2">
            ...
            <li className="mt-2">
              Nơi lưu trú xác nhận đang áp dụng biện pháp vệ sinh và khử trùng
              theo quy định của ALLSAFE (Accor Hotels).
            </li>
            <li className="mt-2">
              Vui lòng lưu ý các chuẩn mực về văn hóa và chính sách khách có thể
              khác nhau theo từng quốc gia và nơi lưu trú. Thông tin về chính
              sách do nơi lưu trú cung cấp.
            </li>
          </ul>
          ...
          <ul className="mt-2 list-disc  pl-4">
            ...
            <li className="mt-2">
              Có phòng thông nhau - có thể đáp ứng tùy thuộc tình trạng phòng
              thực tế - khách có thể liên hệ trực tiếp qua thông tin được cung
              cấp trong xác nhận đặt phòng để yêu cầu.
            </li>
            <li className="mt-2">
              Khách không được phép mang vật nuôi, bao gồm cả vật nuôi hỗ trợ
              người khuyết tật, vào nơi lưu trú này.
            </li>
            <li className="mt-2">
            ...
            <li className="mt-2">
              Nơi lưu trú này chào đón khách thuộc mọi xu hướng tính dục và nhận
