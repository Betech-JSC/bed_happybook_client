...
export default function Service() {
  return (
    <div className="py-8 px-3 lg:px-[80px] bg-[#F9FAFB]">
      <div className="flex justify-between">
        <div>
          ...
          <p className="font-medium">
            HappyBook cam kết mang đến cho quý khách hàng những dịch vụ tốt nhất
            với chi phí hợp lý, bao gồm:
          </p>
        </div>
      </div>
        ...
        <div className={AboutUs.service_item}>
          ...
          <div className="mt-2">
            ...
            <p className="mt-2 leading-6 text-justify">
              HappyBook là đơn vị chuyên xử lý vé đoàn, vé quốc tế đặc biệt các
              chặng bay Úc/ Châu Âu/Mỹ/Canada với giá cực kì tốt giảm sâu tới
              50%
            </p>
        ...
        <div className={AboutUs.service_item}>
          ...
          <div className="mt-2">
            ...
            <p className="mt-3 leading-6 text-justify">
              ...
              logic, giúp tỉ lệ đậu cao nhất với chi phí xử lý cực kỳ cạnh tranh
            </p>
          </div>
        </div>
        <div className={AboutUs.service_item}>
          ...
          <div className="mt-2">
            ...
            <p className="mt-2 leading-6 text-justify">
              ...
              nghỉ dưỡng, Combo Vé máy bay và khách sạn của Happy Book tập trung
              dòng sản phẩm cao cấp phù hợp với nhóm, gia đình giúp khách hàng
              có những trải nghiệm hài lòng
            </p>
          </div>
        </div>
        <div className={AboutUs.service_item}>
          ...
          <div className="mt-2">
            ...
            <p className="mt-2 leading-6 text-justify">
              HappBook cung cấp các tour du lịch quốc tế chất lượng, giá cả cạnh
              tranh nhất. Các Tour nổi bật: Thái Lan, Trung Quốc, Hàn Quốc, Nhật
              Bản, Châu Âu, Mỹ,...
            </p>
          </div>
        </div>
