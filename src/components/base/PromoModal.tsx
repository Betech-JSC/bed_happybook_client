                    ...
                    <div className="w-full mt-8 space-y-2">
                        <div className="w-full">
                            <Link
                                href="/ve-may-bay"
                                onClick={() => setShow(false)}
                                className="block w-full text-center bg-[#F15A24] text-white font-bold text-lg py-3 px-6 rounded-lg shadow-md hover:bg-orange-600 transition transform hover:-translate-y-1"
                            >
                                Đặt vé ngay nhé!
                            </Link>
                        </div>
                        ...
                        <div className="w-full">
                            <Link
                                ...
                                onClick={() => setShow(false)}
                                className="block w-full text-center border-2 border-[#0055D9] text-[#0055D9] font-bold text-lg py-3 px-6 rounded-lg hover:bg-[#0055D9] hover:text-white transition"
                            >
                                Thể lệ chương trình
                            </Link>
                        </div>
