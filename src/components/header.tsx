...
export default function Header() {
  ...
  return (
    <header
      className="text-white relative lg:px-[50px] xl:px-[80px] sm:px-3 hidden lg:block"
      style={{
        backgroundImage:
    ...
    >
      <div className="mx-auto flex justify-between items-center py-4 relative">
        {/* Logo */}
        ...
        {/* Search Bar */}
        <div className="flex items-center lg:w-[20%] xl:w-[25%]">
          <input
            type="text"
        ...
        <a href="#" className="hover:border-b-[3px] hover:border-[#F27145]">
          Về chúng tôi
        </a>
        <a href="#" className="hover:border-b-[3px] hover:border-[#F27145]">
          Liên hệ
        ...
        <a
          ...
          className="flex items-center space-x-2 border border-white px-3 rounded-3xl hover:bg-blue-600"
        >
          <Image
            src="/icon/phone.svg"
            alt="Phone icon"
        ...
        <a
          className={`bg-[#1570EF] hover:bg-white cursor-pointer flex items-center space-x-2 py-2 px-4 rounded-3xl outline-none ${styles.text_hover_default}`}
        >
          <span>Đăng nhập</span>
        </a>
        {/* Menu Button */}
