        ...
        <div className="mx-3 my-2 bg-white rounded-2xl pt-3 pb-3 px-4 shadow-[0_4px_30px_rgba(0,0,0,0.05)] border border-[#F2F4F7]">
          ...
          <div className="grid grid-cols-3 gap-x-1.5 gap-y-2 w-full max-w-[310px] mx-auto items-start">
            ...
            >
              ...
              <span className="px-1 mt-0.5 text-[14px] font-bold block leading-tight">
            ...
            <Link
              href="/du-thuyen"
              className="rounded-xl text-center min-h-[62px] h-fit pb-1 flex flex-col items-center justify-start pt-1 bg-transparent text-[#344054] hover:bg-blue-50 hover:text-[#1570EF]"
            >
              <div className="w-9 h-9 flex items-center justify-center shrink-0">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="px-1 mt-0.5 text-[14px] font-bold block leading-tight">{t("du_thuyen")}</span>
            </Link>
            ...
            >
              ...
              <span className="px-1 mt-0.5 text-[14px] font-bold block leading-tight">{t("tours")}</span>
            </Link>
            ...
            >
              ...
              <span className="px-1 mt-0.5 text-[14px] font-bold block leading-tight">{t("ve_tau") || "Vé tàu"}</span>
            </Link>
            ...
            >
              ...
              <span className="px-1 mt-0.5 text-[14px] font-bold block leading-tight">{t("thue_xe") || "Thuê xe"}</span>
            </Link>
          </div>
        </div>
