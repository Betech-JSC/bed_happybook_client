  ...
  return (
    <div className={`relative w-full ${activeTabMb ? "z-20" : "z-0"}`}>
      ...
      <div className="relative">
        <div className="mx-3 my-2 bg-white rounded-2xl p-3 pb-3.5 shadow-[0_4px_30px_rgba(0,0,0,0.05)] border border-[#F2F4F7]">
          {/* Search Bar Grid */}
          <div className="grid grid-cols-3 gap-x-1.5 gap-y-2 w-full mx-auto">
            {/* Tab 1 */}
            <div
            ...
            >
              ...
              <span className="px-1 mt-1 text-[10px] font-bold block leading-tight">
            ...
            >
              ...
              <span className="px-1 mt-1 text-[10px] font-bold block leading-tight">{t("du_thuyen")}</span>
            </Link>
            ...
            >
              ...
              <span className="px-1 mt-1 text-[10px] font-bold block leading-tight">{t("tours")}</span>
            </Link>
            ...
            >
              ...
              <span className="px-1 mt-1 text-[10px] font-bold block leading-tight">{t("ve_tau") || "Vé tàu"}</span>
            </Link>
            ...
            >
              ...
              <span className="px-1 mt-1 text-[10px] font-bold block leading-tight">{t("thue_xe") || "Thuê xe"}</span>
            </Link>
          </div>
        </div>
