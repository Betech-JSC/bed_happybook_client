  ...
  return (
    <Fragment>
      ...
      <div className="relative">
        {/* Search Bar Grid */}
        <div className="grid grid-cols-3 gap-1.5 md:gap-2 my-4 px-3 md:px-1">
          {/* Tab 1 */}
          <div
            onClick={() => setActiveTabMb("ve-may-bay")}
            className={`rounded-2xl text-center h-[104px] block content-center cursor-pointer ${
          ...
          >
            ...
            <span className="px-1 mt-2 text-xs font-semibold block">{t("ve_may_bay")}</span>
          </div>
          ...
          >
            ...
            <span className="px-1 mt-2 text-xs font-semibold block">{t("khach_san")}</span>
          </div>
          ...
          >
            ...
            <span className="px-1 mt-2 text-xs font-semibold block">{t("visa")}</span>
          </div>

          {/* Tab 4 */}
          <div
            onClick={() => setActiveTabMb("sim-du-lich")}
            className={`rounded-2xl text-center h-[104px] block content-center cursor-pointer ${
          ...
          >
            ...
            <span className="px-1 mt-2 text-xs font-semibold block">{t("sim_du_lich")}</span>
          </div>
          ...
          >
            ...
            <span className="px-1 mt-2 text-xs font-semibold block">{t("combo_tiet_kiem")}</span>
          </div>

          {/* Tab 6 */}
          <div
            onClick={() => setActiveTabMb("airport-service")}
            className={`rounded-2xl text-center h-[104px] block content-center cursor-pointer ${
          ...
          >
            ...
            <span className="px-1 mt-2 text-xs font-semibold block">{t("dich_vu_tai_san_bay")}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 gap-1.5 md:gap-2 my-4 px-3 md:px-1">
          ...
          >
            ...
            <span className="px-1 mt-2 text-xs font-semibold">{t("tours")}</span>
          </Link>
          <Link
            href="/du-thuyen"
            className="rounded-2xl text-center h-[104px] block content-center bg-[#00000054] text-white"
          >
            ...
            <span className="px-1 mt-2 text-xs font-semibold">{t("du_thuyen")}</span>
          </Link>
          <Link
            href="/combo"
            className="rounded-2xl text-center h-[104px] block content-center bg-[#00000054] text-white"
