        ...
        <div className="mx-3 my-2 bg-white rounded-2xl p-2 pb-2.5 shadow-[0_4px_30px_rgba(0,0,0,0.05)] border border-[#F2F4F7]">
          ...
          <div className="grid grid-cols-3 gap-x-1.5 gap-y-1 w-full mx-auto items-start">
            ...
            <div
              ...
              className={`rounded-xl text-center min-h-[82px] h-fit pb-1.5 flex flex-col items-center justify-start pt-1 cursor-pointer ${activeTabMb === "ve-may-bay" ? "bg-blue-50 text-[#1570EF]" : "bg-transparent text-[#344054]"
                }`}
            >
              <div className="w-10 h-10 bg-[#1570EF] rounded-full flex items-center justify-center shrink-0">
                <Image
              ...
              <span className="px-1 mt-0.5 text-[13px] font-bold block leading-tight">{t("ve_may_bay")}</span>
            </div>

            {/* Tab 2 */}
            <div
              onClick={() => setActiveTabMb(activeTabMb === "hotel" ? null : "hotel")}
              className={`rounded-xl text-center min-h-[82px] h-fit pb-1.5 flex flex-col items-center justify-start pt-1 cursor-pointer ${activeTabMb === "hotel" ? "bg-blue-50 text-[#1570EF]" : "bg-transparent text-[#344054]"
                }`}
            >
              <div className="w-10 h-10 bg-[#1570EF] rounded-full flex items-center justify-center shrink-0">
                <Image
              ...
              <span className="px-1 mt-0.5 text-[13px] font-bold block leading-tight">{t("khach_san")}</span>
            </div>

            {/* Tab 3 */}
            <div
              onClick={() => setActiveTabMb(activeTabMb === "visa" ? null : "visa")}
              className={`rounded-xl text-center min-h-[82px] h-fit pb-1.5 flex flex-col items-center justify-start pt-1 cursor-pointer ${activeTabMb === "visa" ? "bg-blue-50 text-[#1570EF]" : "bg-transparent text-[#344054]"
                }`}
            >
              <div className="w-10 h-10 bg-[#1570EF] rounded-full flex items-center justify-center shrink-0">
                <svg
              ...
              <span className="px-1 mt-0.5 text-[13px] font-bold block leading-tight">{t("visa")}</span>
            </div>

            {/* Tab 4 */}
            <div
              onClick={() => setActiveTabMb(activeTabMb === "sim-du-lich" ? null : "sim-du-lich")}
              className={`rounded-xl text-center min-h-[82px] h-fit pb-1.5 flex flex-col items-center justify-start pt-1 cursor-pointer ${activeTabMb === "sim-du-lich" ? "bg-blue-50 text-[#1570EF]" : "bg-transparent text-[#344054]"
                }`}
            >
              <div className="w-10 h-10 bg-[#1570EF] rounded-full flex items-center justify-center shrink-0">
                <svg
              ...
              <span className="px-1 mt-0.5 text-[13px] font-bold block leading-tight">{t("sim_du_lich")}</span>
            </div>

            {/* Tab 5 */}
            <div
              onClick={() => setActiveTabMb(activeTabMb === "combo" ? null : "combo")}
              className={`rounded-xl text-center min-h-[82px] h-fit pb-1.5 flex flex-col items-center justify-start pt-1 cursor-pointer ${activeTabMb === "combo" ? "bg-blue-50 text-[#1570EF]" : "bg-transparent text-[#344054]"
                }`}
            >
              <div className="w-10 h-10 bg-[#1570EF] rounded-full flex items-center justify-center shrink-0">
                <svg
              ...
              <span className="px-1 mt-0.5 text-[13px] font-bold block leading-tight">{t("combo_tiet_kiem")}</span>
            </div>

            {/* Tab 6 */}
            <div
              onClick={() => setActiveTabMb(activeTabMb === "airport-service" ? null : "airport-service")}
              className={`rounded-xl text-center min-h-[82px] h-fit pb-1.5 flex flex-col items-center justify-start pt-1 cursor-pointer ${activeTabMb === "airport-service" ? "bg-blue-50 text-[#1570EF]" : "bg-transparent text-[#344054]"
                }`}
            >
              <div className="w-10 h-10 bg-[#1570EF] rounded-full flex items-center justify-center shrink-0">
                <svg
              ...
              <span className="px-1 mt-0.5 text-[13px] font-bold block leading-tight">{t("don_tien_uu_tien_fast_track") || "Đón tiễn ưu tiên (FastTrack)"}</span>
            </div>
            ...
            <div
              ...
              className={`rounded-xl text-center min-h-[70px] h-fit pb-1 flex flex-col items-center justify-start pt-1 cursor-pointer ${activeTabMb === "phong-cho-thuong-gia" ? "bg-blue-50 text-[#1570EF]" : "bg-transparent text-[#344054]"
                }`}
            >
              ...
              <span className="px-1 mt-0.5 text-[13px] font-bold block leading-tight">
            ...
            <Link
              href="/du-thuyen"
              className="rounded-xl text-center min-h-[70px] h-fit pb-1 flex flex-col items-center justify-start pt-1 bg-transparent text-[#344054]"
            >
              ...
              <span className="px-1 mt-0.5 text-[13px] font-bold block leading-tight">{t("du_thuyen")}</span>
            </Link>

            {/* Vé vui chơi */}
            <div
              onClick={() => setActiveTabMb(activeTabMb === "ve-vui-choi" ? null : "ve-vui-choi")}
              className={`rounded-xl text-center min-h-[70px] h-fit pb-1 flex flex-col items-center justify-start pt-1 cursor-pointer ${activeTabMb === "ve-vui-choi" ? "bg-blue-50 text-[#1570EF]" : "bg-transparent text-[#344054]"
                }`}
            >
            ...
            >
              ...
              <span className="px-1 mt-0.5 text-[13px] font-bold block leading-tight">{t("tours")}</span>
            </Link>
            ...
            >
              ...
              <span className="px-1 mt-0.5 text-[13px] font-bold block leading-tight">{t("ve_tau") || "Vé tàu"}</span>
            </Link>
            ...
            >
              ...
              <span className="px-1 mt-0.5 text-[13px] font-bold block leading-tight">{t("thue_xe") || "Thuê xe"}</span>
            </Link>
          </div>
        </div>
