...
export default function Footer() {
  return (
    <div className="mt-12 px-3 lg:px-[80px] pt-12 pb-6 bg-[#F9FAFB]">
      <div className="flex flex-col lg:flex-row">
        <div className="basis-1/2">
          <div className="pb-12">
            <Image src="/logo-footer.png" alt="Icon" width={287} height={72} />
          </div>
          <p>
          ...
          <p>
            <strong>Hotline Visa - hộ chiếu</strong> 0708.628.791 - 0904.221.293
          </p>
          <p>
          ...
          <p>
            <strong>Email tuyển dụng - đăng ký CTV:</strong> HR@happybook.com.vn
          </p>
          <p>
        ...
        <div className="mt-12 lg:mt-0 basis-1/2 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-12">
          <div>
            ...
            <div className="flex space-x-3 mt-4">
              <button>
                <Image src="/social/fb.png" alt="Icon" width={32} height={32} />
              </button>
              <button>
                <Image
      ...
      <div className="mt-8 text-center">
        ...
        <p className="text-[12px]">
          Mã số doanh nghiệp: 0314012158 do Sở Kế hoạch & Đầu tư TP HCM cấp ngày
